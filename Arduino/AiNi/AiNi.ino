...
char ssid[] = "Xixi&Qiqi";        //  your network SSID (name)
char pass[] = "05A81f95!";           // your network password
...
char filename_Web_test[] = "AiNi.html"; //name of the HTML file saved in SD card
